            ...
            <div class="md:col-span-2 lg:col-span-1" >
                <div class="h-full py-8 px-6 space-y-6 rounded-md dark:border border-gray-200 dark:bg-white bg-[#171818]">
                    <svg class="w-40 m-auto opacity-75" viewBox="0 0 146 146" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <circle class="dark:block hidden" cx="73.5" cy="72.5" r="29" fill="#e4e4f2" stroke="#e4e4f2"/>
                    ...
                    <div>
                        <h5 class="text-2xl dark:text-[#171818] text-gray-100 text-center font-body font-bold">Vehicles Condition</h5>
                        <div class="mt-2 flex justify-center gap-4">
                            <h3 class="text-3xl font-bold dark:text-gray-700 text-gray-50">$23,988</h3>
...
<path d="M6.00001 0L12 8H-3.05176e-05L6.00001 0Z" fill="currentColor"/>
                        ...
                        <span class="block text-center text-gray-400 dark:text-gray-500 font-body font-bold">Compared to last week $13,988</span>
                    </div>
                    <table class="w-full dark:text-[#171818] text-gray-200">
                        <tbody>
                            <tr>
                                <td class="py-2 font-body">Ready To Rent</td>
                                <td class="dark:text-gray-500 font-body font-bold text-gray-300">152</td>
                                <td>
                                    <svg class="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                       <rect opacity="0.2" width="17" height="21" rx="1" fill="#6c757d"/>
                                        <rect opacity="0.2" x="19" width="14" height="21" rx="1" fill="#6c757d"/>
                                        <rect opacity="0.2" x="35" width="14" height="21" rx="1" fill="#6c757d"/>
                                        <rect opacity="0.2" x="51" width="17" height="21" rx="1" fill="#6c757d"/>
                            ...
                            <tr>
                                <td class="py-2 font-body">In Service</td>
                                <td class="dark:text-gray-500 font-body font-bold text-gray-300">350</td>
                                <td>
                                    <svg class="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect opacity="0.2" width="17" height="21" rx="1" fill="#6c757d"/>
                                        <rect opacity="0.2" x="19" width="14" height="21" rx="1" fill="#6c757d"/>
                            ...
                            <tr>
                                <td class="py-2 font-body">Under Maintenance</td>
                                <td class="dark:text-gray-500 font-body font-bold text-gray-300">12</td>
                                <td>
                                    <svg class="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect opacity="0.2" width="17" height="21" rx="1" fill="#6c757d"/>
                                        <rect opacity="0.2" x="19" width="14" height="21" rx="1" fill="#6c757d"/>
            ...
            <div>
                <div class="h-full py-6 px-6 rounded-md dark:border border-gray-200 dark:bg-white bg-[#171818]">
                    <h5 class="text-2xl dark:text-[#171818] text-gray-100 font-body font-bold">Visits</h5>
                    <div class="my-8">
                        <h1 class="text-5xl font-body font-bold dark:text-[#171818] text-gray-100">64,5%</h1>
                        <span class="text-center text-gray-400 dark:text-gray-500 font-body font-bold">Compared to last week 13,788 visit</span>
                    </div>
                    ...
                    <table class="mt-6 -mb-2 w-full dark:text-[#171818] text-gray-200">
                        <tbody>
                            <tr>
                                <td class="py-2 font-body ">From new users</td>
                                <td class="dark:text-gray-500 font-body font-bold text-gray-300">1296</td>
                                <td>
                                    <svg class="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect opacity="0.2" width="17" height="21" rx="1" fill="#6c757d"/>
                                        <rect opacity="0.2" x="19" width="14" height="21" rx="1" fill="#6c757d"/>
                            ...
                            <tr>
                                <td class="py-2 font-body">From old users</td>
                                <td class="dark:text-gray-500 font-body font-bold text-gray-300">1750</td>
                                <td>
                                    <svg class="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect opacity="0.2" width="17" height="21" rx="1" fill="#6c757d"/>
                                        <rect opacity="0.2" x="19" width="14" height="21" rx="1" fill="#6c757d"/>
            ...
            <div>
                <div class="lg:h-full py-8 px-6 text-gray-600 rounded-md dark:border border-gray-200 dark:bg-white bg-[#171818]">
                    ...
                    <div class="mt-6">
                        <h5 class="text-2xl dark:text-[#171818] text-gray-100 font-body font-bold text-center">Progress</h5>
                        <div class="mt-2 flex justify-center gap-4">
                            <h3 class="text-3xl font-body font-bold dark:text-[#171818] text-gray-100">83%</h3>
                            <div class="flex items-end gap-1 text-green-500">
                                <svg class="w-3" viewBox="0 0 12 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M6.00001 0L12 8H-3.05176e-05L6.00001 0Z" fill="currentColor"/>
                                </svg>
                    ...
                    <table class="mt-6 -mb-2 w-full text-gray-600">
                        <tbody>
                            <tr>
                                <td class="py-2">The Progress</td>
                                <td class="text-gray-500">83%</td>
                                <td>
                                    <svg class="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect opacity="0.2" width="17" height="21" rx="1" fill="#6c757d"/>
                                        <rect opacity="0.2" x="19" width="14" height="21" rx="1" fill="#6c757d"/>
