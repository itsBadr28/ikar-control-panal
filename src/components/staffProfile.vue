<template>
  ...
  <div class="fixed z-10 inset-0 overflow-y-auto" id="modal"
    :class="{ hidden: !staffProfileModalShow }">
      ...
      <div class="inline-block align-bottom bg-[#171818] rounded-lg text-left overflow-hidden
        ...
        <div class="my-auto bg-[#171818] dark:bg-[#f1f0fe] text-left px-6">
          ...
          <div class="flex justify-between items-center px-2 pt-1 pb-2 ">
            ...
            <!-- Modal Close Button -->
            <div class="modal-close cursor-pointer z-50" @click.prevent="togglestaffProfile">
    ...
    <div class="w-100 flex flex-grow flex-col items-end justify-start">
      <div class="flex flex-row space-x-3">
        <!-- Follow Button -->
        <button
          class="flex rounded-sm bg-yellow-500 py-2 px-4 text-white transition-all duration-150 ease-in-out hover:bg-yellow-600">
          <font-awesome-icon class="my-auto mr-2" icon="triangle-exclamation" />
            Warning
        </button>

        <!-- More Actions Button -->
        <button class="flex rounded-md dark:bg-gray-100 bg-gray-700 py-2 px-1 text-white 
